...
var AtActionSheetBody = /** @class */ (function (_super) {
    ...
    AtActionSheetBody.prototype.render = function () {
        ...
        return React__default["default"].createElement(components.View, { className: rootClass }, this.props.children);
    };
...
var AtActionSheetFooter = /** @class */ (function (_super) {
    ...
    AtActionSheetFooter.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { onClick: this.handleClick, className: rootClass }, this.props.children));
    };
...
var AtActionSheet = /** @class */ (function (_super) {
    ...
    AtActionSheet.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootClass, onTouchMove: this.handleTouchMove },
            React__default["default"].createElement(components.View, { onClick: this.close, className: 'at-action-sheet__overlay' }),
            React__default["default"].createElement(components.View, { className: 'at-action-sheet__container' },
                title && React__default["default"].createElement(AtActionSheetHeader, null, title),
                React__default["default"].createElement(AtActionSheetBody, null, this.props.children),
                cancelText && (React__default["default"].createElement(AtActionSheetFooter, { onClick: this.handleCancel }, cancelText)))));
    };
...
var AtActionSheetItem = /** @class */ (function (_super) {
    ...
    AtActionSheetItem.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootClass, onClick: this.handleClick }, this.props.children));
    };
...
function getEventDetail(event) {
    var detail;
    switch (ENV$4) {
        case Taro__default["default"].ENV_TYPE.WEB:
            detail = {
                pageX: event.pageX,
                pageY: event.pageY,
            ...
            break;
        case Taro__default["default"].ENV_TYPE.WEAPP:
            detail = {
            ...
            break;
        case Taro__default["default"].ENV_TYPE.ALIPAY:
            detail = {
...
function handleTouchScroll(flag) {
    if (ENV$4 !== Taro__default["default"].ENV_TYPE.WEB) {
        return;
    }
    if (flag) {
...
var AtLoading = /** @class */ (function (_super) {
    ...
    AtLoading.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: 'at-loading', style: sizeStyle },
            React__default["default"].createElement(components.View, { className: 'at-loading__ring', style: ringStyle }),
            React__default["default"].createElement(components.View, { className: 'at-loading__ring', style: ringStyle }),
            React__default["default"].createElement(components.View, { className: 'at-loading__ring', style: ringStyle })));
    };
    return AtLoading;
...
var AtActivityIndicator = /** @class */ (function (_super) {
    ...
    AtActivityIndicator.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootClass },
            React__default["default"].createElement(components.View, { className: 'at-activity-indicator__body' },
                React__default["default"].createElement(AtLoading, { size: size, color: color })),
            content && (React__default["default"].createElement(components.Text, { className: 'at-activity-indicator__content' }, content))));
    };
...
var AtAvatar = /** @class */ (function (_super) {
    ...
    AtAvatar.prototype.render = function () {
        ...
        if (openData && openData.type === 'userAvatarUrl' && this.state.isWEAPP) {
            elem = React__default["default"].createElement(components.OpenData, { type: openData.type });
        }
        else if (image) {
            elem = React__default["default"].createElement(components.Image, { className: 'at-avatar__img', src: image });
        }
        else {
            elem = React__default["default"].createElement(components.Text, { className: 'at-avatar__text' }, letter);
        }
        return (React__default["default"].createElement(components.View, { className: classnames(rootClassName, classObject, this.props.className), style: customStyle }, elem));
    };
    return AtAvatar;
}(React__default["default"].Component));
...
var AtBadge = /** @class */ (function (_super) {
    ...
    AtBadge.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: classnames(rootClassName, this.props.className), style: customStyle },
            this.props.children,
            dot ? (React__default["default"].createElement(components.View, { className: 'at-badge__dot' })) : (val !== '' && React__default["default"].createElement(components.View, { className: 'at-badge__num' }, val))));
    };
    return AtBadge;
}(React__default["default"].Component));
...
var AtButton = /** @class */ (function (_super) {
    ...
    AtButton.prototype.render = function () {
        ...
        if (loading) {
            loadingComponent = (React__default["default"].createElement(components.View, { className: 'at-button__icon' },
                React__default["default"].createElement(AtLoading, { color: loadingColor, size: loadingSize })));
            rootClassName.push('at-button--icon');
        }
        var webButton = (React__default["default"].createElement(components.Button, { className: 'at-button__wxbutton', lang: lang, formType: formType }));
        var button = (React__default["default"].createElement(components.Button, { className: 'at-button__wxbutton', formType: formType, openType: openType, lang: lang, sessionFrom: sessionFrom, sendMessageTitle: sendMessageTitle, sendMessagePath: sendMessagePath, sendMessageImg: sendMessageImg, showMessageCard: showMessageCard, appParameter: appParameter, onGetUserInfo: this.onGetUserInfo.bind(this), onGetPhoneNumber: this.onGetPhoneNumber.bind(this), onOpenSetting: this.onOpenSetting.bind(this), onError: this.onError.bind(this), onContact: this.onContact.bind(this) }));
        return (React__default["default"].createElement(components.View, { className: classnames(rootClassName, classObject, this.props.className), style: customStyle, onClick: this.onClick.bind(this) },
            isWEB && !disabled && webButton,
            isWEAPP && !disabled && button,
            isALIPAY && !disabled && button,
            loadingComponent,
            React__default["default"].createElement(components.View, { className: 'at-button__text' }, this.props.children)));
    };
    return AtButton;
}(React__default["default"].Component));
    ...
    AtCard.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { onClick: this.handleClick, className: rootClass },
            React__default["default"].createElement(components.View, { className: 'at-card__header' },
                thumb && (React__default["default"].createElement(components.View, { className: 'at-card__header-thumb' },
                    React__default["default"].createElement(components.Image, { className: 'at-card__header-thumb-info', mode: 'scaleToFill', src: thumb }))),
                renderIcon || '',
...
var AtCheckbox = /** @class */ (function (_super) {
    ...
    AtCheckbox.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle }, options.map(function (option, idx) {
            ...
            return (React__default["default"].createElement(components.View, { className: optionCls, key: value, onClick: _this.handleClick.bind(_this, idx) },
                React__default["default"].createElement(components.View, { className: 'at-checkbox__option-wrap' },
                    React__default["default"].createElement(components.View, { className: 'at-checkbox__option-cnt' },
                        React__default["default"].createElement(components.View, { className: 'at-checkbox__icon-cnt' },
                            React__default["default"].createElement(components.Text, { className: 'at-icon at-icon-check' })),
                        React__default["default"].createElement(components.View, { className: 'at-checkbox__title' }, label)),
                    desc && React__default["default"].createElement(components.View, { className: 'at-checkbox__desc' }, desc))));
        })));
    };
    return AtCheckbox;
}(React__default["default"].Component));
            ...
            React__default["default"].createElement(components.View, { className: 'at-list__item-container' },
                ...
                React__default["default"].createElement(components.View, { className: 'at-list__item-content item-content' },
                    React__default["default"].createElement(components.View, { className: 'item-content__info' },
                        ...
                        note && React__default["default"].createElement(components.View, { className: 'item-content__info-note' }, note))),
                React__default["default"].createElement(components.View, { className: 'at-list__item-extra item-extra' },
                    extraText && React__default["default"].createElement(components.View, { className: 'item-extra__info' }, extraText),
                    extraThumb && !extraText && (React__default["default"].createElement(components.View, { className: 'item-extra__image' },
                        React__default["default"].createElement(components.Image, { className: 'item-extra__image-info', mode: 'aspectFit', src: extraThumb }))),
...
var AtFloatLayout = /** @class */ (function (_super) {
    ...
    AtFloatLayout.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootClass, onTouchMove: this.handleTouchMove },
            React__default["default"].createElement(components.View, { onClick: this.close, className: 'at-float-layout__overlay' }),
            React__default["default"].createElement(components.View, { className: 'at-float-layout__container layout' },
                title ? (React__default["default"].createElement(components.View, { className: 'layout-header' },
...
var AtForm = /** @class */ (function (_super) {
    ...
    AtForm.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.Form, { className: rootCls, style: customStyle, onSubmit: this.onSubmit.bind(this), reportSubmit: reportSubmit, onReset: this.onReset.bind(this) }, this.props.children));
    };
    return AtForm;
}(React__default["default"].Component));
AtForm.defaultProps = {
            ...
            return (React__default["default"].createElement(components.View, { key: "at-grid-item-".concat(index), className: classnames(bodyClass, {
                ...
                React__default["default"].createElement(components.View, { className: 'at-grid-item__content' },
                    React__default["default"].createElement(components.View, { className: 'at-grid-item__content-inner' },
                        ...
                        React__default["default"].createElement(components.Text, { className: 'content-inner__text' }, childItem.value)))));
        }))); })));
    };
    return AtGrid;
}(React__default["default"].Component));
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle },
            React__default["default"].createElement(components.View, { className: containerCls },
                ...
                error && (React__default["default"].createElement(components.View, { className: 'at-input__icon', onTouchStart: this.handleErrorClick },
                    React__default["default"].createElement(components.Text, { className: 'at-icon at-icon-alert-circle at-input__icon-alert' }))),
                React__default["default"].createElement(components.View, { className: 'at-input__children' }, this.props.children))));
    };
    return AtInput;
}(React__default["default"].Component));
...
var AtInputNumber = /** @class */ (function (_super) {
    ...
    AtInputNumber.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle },
            React__default["default"].createElement(components.View, { className: minusBtnCls, onClick: this.handleClick.bind(this, 'minus') },
                React__default["default"].createElement(components.Text, { className: 'at-icon at-icon-subtract at-input-number__btn-subtract' })),
            React__default["default"].createElement(components.Input, { className: 'at-input-number__input', style: inputStyle, type: type, value: String(inputValue), disabled: disabledInput || disabled, onInput: this.handleInput, onBlur: this.handleBlur }),
            React__default["default"].createElement(components.View, { className: plusBtnCls, onClick: this.handleClick.bind(this, 'plus') },
                React__default["default"].createElement(components.Text, { className: 'at-icon at-icon-add at-input-number__btn-add' }))));
    };
...
var AtModalAction = /** @class */ (function (_super) {
    ...
    AtModalAction.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootClass },
            React__default["default"].createElement(components.View, { className: 'at-modal__action' }, this.props.children)));
    };
...
var AtModalContent = /** @class */ (function (_super) {
    ...
    AtModalContent.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.ScrollView, { scrollY: true, className: rootClass }, this.props.children));
    };
...
var AtModal = /** @class */ (function (_super) {
    ...
    AtModal.prototype.render = function () {
        ...
        if (title || content) {
            ...
            return (React__default["default"].createElement(components.View, { className: rootClass },
                React__default["default"].createElement(components.View, { onClick: this.handleClickOverlay, className: 'at-modal__overlay' }),
                React__default["default"].createElement(components.View, { className: 'at-modal__container' },
                    ...
                    isRenderAction && (React__default["default"].createElement(AtModalAction, { isSimple: true },
                        cancelText && (React__default["default"].createElement(components.Button, { onClick: this.handleCancel }, cancelText)),
                        confirmText && (React__default["default"].createElement(components.Button, { onClick: this.handleConfirm }, confirmText)))))));
        }
        return (React__default["default"].createElement(components.View, { onTouchMove: this.handleTouchMove, className: rootClass },
            React__default["default"].createElement(components.View, { className: 'at-modal__overlay', onClick: this.handleClickOverlay }),
            React__default["default"].createElement(components.View, { className: 'at-modal__container' }, this.props.children)));
    };
    return AtModal;
}(React__default["default"].Component));
...
var AtNavBar = /** @class */ (function (_super) {
    ...
    AtNavBar.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: classnames({
            ...
            React__default["default"].createElement(components.View, { className: 'at-nav-bar__right-view' },
...
var AtNoticebar = /** @class */ (function (_super) {
        ...
        this.timeout = setTimeout(function () {
            ...
            if (_this.state.isWEB) {
                ...
                query
                    ...
                    var resetAnimation = Taro__default["default"].createAnimation({
                        duration: 0,
                        timingFunction: 'linear'
                    });
                    var resetOpacityAnimation = Taro__default["default"].createAnimation({
                        duration: 0,
                        timingFunction: 'linear'
                    });
    ...
    AtNoticebar.prototype.render = function () {
        ...
        return (show && (React__default["default"].createElement(components.View, { className: classnames(rootClassName, classObject, className), style: customStyle },
            ...
            React__default["default"].createElement(components.View, { className: 'at-noticebar__content' },
                icon && (React__default["default"].createElement(components.View, { className: 'at-noticebar__content-icon' },
                    React__default["default"].createElement(components.Text, { className: classnames(iconClass, iconClass) }))),
                React__default["default"].createElement(components.View, { className: 'at-noticebar__content-text' },
                    React__default["default"].createElement(components.View, { id: animElemId, animation: animationData, className: classnames(innerClassName), style: style }, this.props.children))),
            showMore && (React__default["default"].createElement(components.View, { className: 'at-noticebar__more', onClick: this.onGotoMore.bind(this) },
                React__default["default"].createElement(components.Text, { className: 'text' }, moreText),
                React__default["default"].createElement(components.View, { className: 'at-noticebar__more-icon' },
                    React__default["default"].createElement(components.Text, { className: 'at-icon at-icon-chevron-right' })))))));
    };
    return AtNoticebar;
}(React__default["default"].Component));
...
var AtPagination = /** @class */ (function (_super) {
    ...
    AtPagination.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: classnames(rootClassName, classObject, this.props.className), style: customStyle },
            React__default["default"].createElement(components.View, { className: 'at-pagination__btn-prev' },
                icon && (React__default["default"].createElement(AtButton, { onClick: this.onPrev.bind(this), size: 'small', disabled: prevDisabled },
                    React__default["default"].createElement(components.Text, { className: 'at-icon at-icon-chevron-left' }))),
                !icon && (React__default["default"].createElement(AtButton, { onClick: this.onPrev.bind(this), size: 'small', disabled: prevDisabled }, "\u4E0A\u4E00\u9875"))),
            React__default["default"].createElement(components.View, { className: 'at-pagination__number' },
                React__default["default"].createElement(components.Text, { className: 'at-pagination__number-current' }, currentPage),
                "/",
                maxPage),
            React__default["default"].createElement(components.View, { className: 'at-pagination__btn-next' },
                icon && (React__default["default"].createElement(AtButton, { onClick: this.onNext.bind(this), size: 'small', disabled: nextDisabled },
                    React__default["default"].createElement(components.Text, { className: 'at-icon at-icon-chevron-right' }))),
                !icon && (React__default["default"].createElement(AtButton, { onClick: this.onNext.bind(this), size: 'small', disabled: nextDisabled }, "\u4E0B\u4E00\u9875")))));
    };
    return AtPagination;
}(React__default["default"].Component));
...
var AtRadio = /** @class */ (function (_super) {
    ...
    AtRadio.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: classnames('at-radio', className), style: customStyle }, options.map(function (option) { return (React__default["default"].createElement(components.View, { key: option.value, onClick: _this.handleClick.bind(_this, option), className: classnames({
                'at-radio__option': true,
                'at-radio__option--disabled': option.disabled
            }) },
            React__default["default"].createElement(components.View, { className: 'at-radio__option-wrap' },
                React__default["default"].createElement(components.View, { className: 'at-radio__option-container' },
                    React__default["default"].createElement(components.View, { className: 'at-radio__title' }, option.label),
                    React__default["default"].createElement(components.View, { className: classnames({
                            'at-radio__icon': true,
                            'at-radio__icon--checked': value === option.value
                        }) },
                        React__default["default"].createElement(components.Text, { className: 'at-icon at-icon-check' }))),
                option.desc && (React__default["default"].createElement(components.View, { className: 'at-radio__desc' }, option.desc))))); })));
    };
    return AtRadio;
}(React__default["default"].Component));
...
var AtSegmentedControl = /** @class */ (function (_super) {
    ...
    AtSegmentedControl.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: mergeStyle(rootStyle, customStyle) }, values.map(function (value, i) { return (React__default["default"].createElement(components.View, { className: classnames('at-segmented-control__item', {
...
var AtSwitch = /** @class */ (function (_super) {
    ...
    AtSwitch.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle },
            React__default["default"].createElement(components.View, { className: 'at-switch__title' }, title),
            React__default["default"].createElement(components.View, { className: containerCls },
                React__default["default"].createElement(components.View, { className: 'at-switch__mask' }),
                React__default["default"].createElement(components.Switch, { className: 'at-switch__switch', checked: checked, color: color, onChange: this.handleChange }))));
    };
    return AtSwitch;
}(React__default["default"].Component));
        ...
        return (React__default["default"].createElement(components.View, { className: classnames({
            ...
            return (React__default["default"].createElement(components.View, { className: classnames('at-tab-bar__item', {
                ...
                item.image ? (React__default["default"].createElement(AtBadge, { dot: !!item.dot, value: item.text, maxValue: Number(item.max) },
                    React__default["default"].createElement(components.View, { className: 'at-tab-bar__icon' },
                        React__default["default"].createElement(components.Image, { className: classnames('at-tab-bar__inner-img', {
                ...
                React__default["default"].createElement(components.View, null,
                    React__default["default"].createElement(AtBadge, { dot: item.iconType || item.image ? false : !!item.dot, value: item.iconType || item.image ? '' : item.text, maxValue: item.iconType || item.image ? 0 : Number(item.max) },
                        React__default["default"].createElement(components.View, { className: 'at-tab-bar__title', style: titleStyle }, item.title)))));
        })));
    };
    return AtTabBar;
}(React__default["default"].Component));
...
var AtTabs = /** @class */ (function (_super) {
    ...
    AtTabs.prototype.getTabHeaderRef = function () {
        if (ENV$3 === Taro__default["default"].ENV_TYPE.WEB) {
    ...
    AtTabs.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: mergeStyle(heightStyle, customStyle) },
            scroll ? (React__default["default"].createElement(components.ScrollView, { id: this._tabId, className: 'at-tabs__header', style: heightStyle, scrollX: scrollX, scrollY: scrollY, scrollWithAnimation: true, scrollLeft: _scrollLeft, scrollTop: _scrollTop, scrollIntoView: _scrollIntoView }, tabItems)) : (React__default["default"].createElement(components.View, { id: this._tabId, className: 'at-tabs__header' }, tabItems)),
            React__default["default"].createElement(components.View, { className: 'at-tabs__body', onTouchStart: this.handleTouchStart.bind(this), onTouchEnd: this.handleTouchEnd.bind(this), onTouchMove: this.handleTouchMove.bind(this), style: mergeStyle(bodyStyle, heightStyle) },
                React__default["default"].createElement(components.View, { className: 'at-tabs__underline', style: underlineStyle }),
                this.props.children)));
    };
    return AtTabs;
}(React__default["default"].Component));
...
var AtTag = /** @class */ (function (_super) {
    ...
    AtTag.prototype.render = function () {
        ...
        var classObject = (_a = {},
            ...
            _a);
        return (React__default["default"].createElement(components.View, { className: classnames(rootClassName, classObject, this.props.className), style: customStyle, onClick: this.onClick.bind(this) }, this.props.children));
    };
    return AtTag;
}(React__default["default"].Component));
AtTag.defaultProps = {
...
var ENV$2 = Taro__default["default"].getEnv();
        ...
        var itemElems = items.map(function (item, index) {
            ...
            return (React__default["default"].createElement(components.View, { className: classnames(itemRootClassName), key: "at-timeline-item-".concat(index), onClick: function (e) { return handleItemClick(index, e); } },
                ...
                React__default["default"].createElement(components.View, { className: 'at-timeline-item__content' },
                    React__default["default"].createElement(components.View, { className: 'at-timeline-item__content-item' }, title),
                    content.map(function (sub, subIndex) { return (React__default["default"].createElement(components.View, { className: 'at-timeline-item__content-item at-timeline-item__content--sub', key: subIndex }, sub)); }))));
        });
        return (React__default["default"].createElement(components.View, { className: classnames(rootClassName, rootClassObject, this.props.className), style: customStyle }, itemElems));
    };
    return AtTimeline;
}(React__default["default"].Component));
...
var AtToast = /** @class */ (function (_super) {
    ...
    AtToast.prototype.render = function () {
        ...
        return _isOpened ? (React__default["default"].createElement(components.View, { className: classnames('at-toast', this.props.className) },
            ...
            React__default["default"].createElement(components.View, { className: bodyClass, style: customStyle, onClick: this.handleClick },
                React__default["default"].createElement(components.View, { className: 'toast-body-content' },
                    realImg ? (React__default["default"].createElement(components.View, { className: 'toast-body-content__img' },
                        React__default["default"].createElement(components.Image, { className: 'toast-body-content__img-item', src: realImg, mode: 'scaleToFill' }))) : null,
                    isRenderIcon && (React__default["default"].createElement(components.View, { className: 'toast-body-content__icon' },
                        React__default["default"].createElement(components.Text, { className: iconClass }))),
                    text && (React__default["default"].createElement(components.View, { className: 'toast-body-content__info' },
                        React__default["default"].createElement(components.Text, null, text))))))) : null;
    };
    return AtToast;
}(React__default["default"].Component));
    ...
    AtAccordion.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle },
            React__default["default"].createElement(components.View, { className: headerCls, onClick: this.handleClick },
                ...
                React__default["default"].createElement(components.View, { className: 'at-accordion__info' },
                    React__default["default"].createElement(components.View, { className: 'at-accordion__info__title' }, title),
                    React__default["default"].createElement(components.View, { className: 'at-accordion__info__note' }, note)),
    ...
    AtSwipeAction.prototype.getAreaWidth = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Taro__default["default"].getSystemInfo()];
                    case 1:
                        systemInfo = _a.sent();
                        this.setState({
...
var AtSearchBar = /** @class */ (function (_super) {
    ...
    AtSearchBar.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle },
            React__default["default"].createElement(components.View, { className: 'at-search-bar__input-cnt' },
...
var AtLoadMore = /** @class */ (function (_super) {
    ...
    AtLoadMore.prototype.render = function () {
        ...
        var component = null;
        if (status === 'loading') {
            component = React__default["default"].createElement(AtActivityIndicator, { mode: 'center', content: loadingText });
        }
        else if (status === 'more') {
            component = (React__default["default"].createElement(components.View, { className: 'at-load-more__cnt' },
                React__default["default"].createElement(AtButton, { full: true, onClick: this.onClick.bind(this), customStyle: moreBtnStyle }, moreText)));
        }
        else {
            component = (React__default["default"].createElement(components.Text, { className: 'at-load-more__tip', style: noMoreTextStyle }, noMoreText));
        }
        return (React__default["default"].createElement(components.View, { className: classnames('at-load-more', className), style: customStyle }, component));
    };
    return AtLoadMore;
}(React__default["default"].Component));
...
var AtDivider = /** @class */ (function (_super) {
    ...
    AtDivider.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: classnames('at-divider', className), style: mergeStyle(rootStyle, customStyle) },
            React__default["default"].createElement(components.View, { className: 'at-divider__content', style: fontStyle }, content === '' ? this.props.children : content),
            React__default["default"].createElement(components.View, { className: 'at-divider__line', style: lineStyle })));
    };
    return AtDivider;
}(React__default["default"].Component));
...
var AtCountdownItem = /** @class */ (function (_super) {
    ...
    AtCountdownItem.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: 'at-countdown__item' },
            React__default["default"].createElement(components.View, { className: 'at-countdown__time-box' },
                React__default["default"].createElement(components.Text, { className: 'at-countdown__time' }, this.formatNum(num))),
            React__default["default"].createElement(components.Text, { className: 'at-countdown__separator' }, separator)));
    };
...
var AtSteps = /** @class */ (function (_super) {
    ...
    AtSteps.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: classnames('at-steps', className), style: customStyle }, !!items &&
            items.map(function (item, i) {
                var _a;
                return (React__default["default"].createElement(components.View, { key: item.title, className: classnames({
                        'at-steps__item': true,
                        'at-steps__item--active': i === current,
                        'at-steps__item--inactive': i !== current
                    }), onClick: _this.handleClick.bind(_this, i) },
                    React__default["default"].createElement(components.View, { className: 'at-steps__circular-wrap' },
                        i !== 0 && React__default["default"].createElement(components.View, { className: 'at-steps__left-line' }),
                        item.status ? (React__default["default"].createElement(components.View, { className: classnames({
                                'at-icon': true,
                    ...
                    React__default["default"].createElement(components.View, { className: 'at-steps__title' }, item.title),
                    React__default["default"].createElement(components.View, { className: 'at-steps__desc' }, item.desc)));
            })));
    };
    return AtSteps;
}(React__default["default"].Component));
    ...
    AtCurtain.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: curtainClass, style: customStyle, onClick: this._stopPropagation },
            React__default["default"].createElement(components.View, { className: 'at-curtain__container' },
                React__default["default"].createElement(components.View, { className: 'at-curtain__body' },
                    this.props.children,
                    React__default["default"].createElement(components.View, { className: btnCloseClass, onClick: this.onClose.bind(this) })))));
    };
    return AtCurtain;
}(React__default["default"].Component));
...
var AtMessage = /** @class */ (function (_super) {
    ...
    AtMessage.prototype.bindMessageListener = function () {
        var _this = this;
        Taro__default["default"].eventCenter.on('atMessage', function (options) {
        ...
        // 绑定函数
        Taro__default["default"].atMessage = Taro__default["default"].eventCenter.trigger.bind(Taro__default["default"].eventCenter, 'atMessage');
    };
    ...
    AtMessage.prototype.componentDidHide = function () {
        Taro__default["default"].eventCenter.off('atMessage');
    };
...
var ENV$1 = Taro__default["default"].getEnv();
var AtImagePicker = /** @class */ (function (_super) {
    ...
    function AtImagePicker() {
        ...
        _this.chooseFile = function () {
            ...
            var filePathName = ENV$1 === Taro__default["default"].ENV_TYPE.ALIPAY ? 'apFilePaths' : 'tempFiles';
            ...
            Taro__default["default"].chooseImage(params)
                .then(function (res) {
        ...
        _this.handleRemoveImg = function (idx, event) {
            ...
            if (ENV$1 === Taro__default["default"].ENV_TYPE.WEB) {
    ...
    AtImagePicker.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle }, matrix.map(function (row, i) { return (React__default["default"].createElement(components.View, { className: 'at-image-picker__flex-box', key: i + 1 }, row.map(function (item, j) {
    ...
    AtRange.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle, onClick: this.handleClick },
            React__default["default"].createElement(components.View, { className: 'at-range__container', style: containerStyle },
                React__default["default"].createElement(components.View, { className: 'at-range__rail', style: railStyle }),
                React__default["default"].createElement(components.View, { className: 'at-range__track', style: mergeStyle(atTrackStyle, trackStyle) }),
                React__default["default"].createElement(components.View, { className: 'at-range__slider', style: mergeStyle(sliderAStyle, sliderStyle), onTouchMove: this.handleTouchMove.bind(this, 'aX'), onTouchEnd: this.handleTouchEnd.bind(this, 'aX') }),
                React__default["default"].createElement(components.View, { className: 'at-range__slider', style: mergeStyle(sliderBStyle, sliderStyle), onTouchMove: this.handleTouchMove.bind(this, 'bX'), onTouchEnd: this.handleTouchEnd.bind(this, 'bX') }))));
    };
    return AtRange;
}(React__default["default"].Component));
...
var AtIndexes = /** @class */ (function (_super) {
    ...
    AtIndexes.prototype.jumpTarget = function (_scrollIntoView, idx) {
        ...
        if (ENV === Taro__default["default"].ENV_TYPE.WEB) {
    ...
    AtIndexes.prototype.updateState = function (state) {
        ...
        if (isVibrate) {
            Taro__default["default"].vibrateShort();
        }
    };
    ...
    AtIndexes.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { className: rootCls, style: customStyle },
            React__default["default"].createElement(AtToast, { customStyle: toastStyle, isOpened: _isShowToast, text: _tipText, duration: 2000 }),
            React__default["default"].createElement(components.View, { className: 'at-indexes__menu', onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd },
                React__default["default"].createElement(components.View, { className: 'at-indexes__menu-item', onClick: this.jumpTarget.bind(this, 'at-indexes__top', 0) }, topKey),
                menuList),
            React__default["default"].createElement(components.ScrollView, { className: 'at-indexes__body', id: this.listId, scrollY: true, scrollWithAnimation: animation, 
                // eslint-disable-next-line no-undefined
                scrollTop: isWEB ? _scrollTop : undefined, scrollIntoView: !isWEB ? _scrollIntoView : '', onScroll: this.handleScroll.bind(this) },
                React__default["default"].createElement(components.View, { className: 'at-indexes__content', id: 'at-indexes__top' }, this.props.children),
                indexesList)));
    };
    return AtIndexes;
}(React__default["default"].Component));
...
var AtCalendarList = /** @class */ (function (_super) {
    ...
    AtCalendarList.prototype.render = function () {
        var _this = this;
        var _a = this.props, list = _a.list, formatter = _a.formatter;
        if (!list || list.length === 0)
            return null;
        return (React__default["default"].createElement(components.View, { className: 'at-calendar__list flex' }, list.map(function (item) {
            var customRender = formatter ? formatter(item).customRender : null;
            return (React__default["default"].createElement(components.View, { key: "list-item-".concat(item.value), onClick: _this.handleClick.bind(_this, item), onLongPress: _this.handleLongClick.bind(_this, item), className: classnames('flex__item', "flex__item--".concat(MAP[item.type]), {
...
var AtCalendarHeader = /** @class */ (function (_super) {
    ...
    AtCalendarHeader.prototype.render = function () {
        return (React__default["default"].createElement(components.View, { className: 'at-calendar__header header' },
            React__default["default"].createElement(components.View, { className: 'header__flex' },
                React__default["default"].createElement(components.View, { className: 'header__flex-item' }, "\u65E5"),
                React__default["default"].createElement(components.View, { className: 'header__flex-item' }, "\u4E00"),
                React__default["default"].createElement(components.View, { className: 'header__flex-item' }, "\u4E8C"),
                React__default["default"].createElement(components.View, { className: 'header__flex-item' }, "\u4E09"),
                React__default["default"].createElement(components.View, { className: 'header__flex-item' }, "\u56DB"),
                React__default["default"].createElement(components.View, { className: 'header__flex-item' }, "\u4E94"),
                React__default["default"].createElement(components.View, { className: 'header__flex-item' }, "\u516D"))));
    };
...
var AtCalendarBody = /** @class */ (function (_super) {
    ...
    AtCalendarBody.prototype.render = function () {
        var _this = this;
        var _a = this.props, isSwiper = _a.isSwiper, formatter = _a.formatter;
        var _b = this.state, isAnimate = _b.isAnimate, offsetSize = _b.offsetSize, listGroup = _b.listGroup;
        if (!isSwiper) {
            return (React__default["default"].createElement(components.View, { className: classnames('main', 'at-calendar-slider__main', "at-calendar-slider__main--".concat(process.env.TARO_ENV)) },
                ...
                React__default["default"].createElement(components.View, { className: 'main__body body' },
                    React__default["default"].createElement(components.View, { className: 'body__slider body__slider--now' },
                        React__default["default"].createElement(AtCalendarList, { formatter: formatter, list: listGroup[1].list, onClick: this.props.onDayClick, onLongClick: this.props.onLongClick })))));
        }
            ...
            return (React__default["default"].createElement(components.View, { className: classnames('main', 'at-calendar-slider__main', "at-calendar-slider__main--".concat(process.env.TARO_ENV)), onTouchEnd: this.handleTouchEnd, onTouchMove: this.handleTouchMove, onTouchStart: this.handleTouchStart },
                ...
                React__default["default"].createElement(components.View, { className: classnames('main__body  body', {
                    ...
                    React__default["default"].createElement(components.View, { className: 'body__slider body__slider--pre' },
                        React__default["default"].createElement(AtCalendarList, { list: listGroup[0].list, formatter: formatter })),
                    React__default["default"].createElement(components.View, { className: 'body__slider body__slider--now' },
                        React__default["default"].createElement(AtCalendarList, { list: listGroup[1].list, onClick: this.props.onDayClick, onLongClick: this.props.onLongClick, formatter: formatter })),
                    React__default["default"].createElement(components.View, { className: 'body__slider body__slider--next' },
                        React__default["default"].createElement(AtCalendarList, { list: listGroup[2].list, formatter: formatter })))));
        }
        return (React__default["default"].createElement(components.View, { className: classnames('main', 'at-calendar-slider__main', "at-calendar-slider__main--".concat(process.env.TARO_ENV)) },
            React__default["default"].createElement(AtCalendarHeader, null),
            React__default["default"].createElement(components.Swiper, { circular: true, current: 1, skipHiddenItemLayout: true, className: classnames('main__body'), onChange: this.handleChange, vertical: this.props.isVertical, onAnimationFinish: this.handleAnimateFinish, onTouchEnd: this.handleSwipeTouchEnd, onTouchStart: this.handleSwipeTouchStart }, listGroup.map(function (item, key) { return (React__default["default"].createElement(components.SwiperItem, { key: key, itemId: key.toString() },
                React__default["default"].createElement(AtCalendarList, { formatter: formatter, list: item.list, onClick: _this.props.onDayClick, onLongClick: _this.props.onLongClick }))); }))));
    };
...
var AtCalendarController = /** @class */ (function (_super) {
    ...
    AtCalendarController.prototype.render = function () {
        ...
        var maxDateValue = dayjsMaxDate
            ...
            : '';
        return (React__default["default"].createElement(components.View, { className: 'at-calendar__controller controller' },
            hideArrow ? null : (React__default["default"].createElement(components.View, { className: classnames('controller__arrow controller__arrow--left', {
                    'controller__arrow--disabled': isMinMonth
                }), onClick: this.props.onPreMonth.bind(this, isMinMonth) })),
            React__default["default"].createElement(components.Picker, { mode: 'date', fields: 'month', end: maxDateValue, start: minDateValue, onChange: this.props.onSelectDate, value: dayjsDate.format('YYYY-MM') },
                React__default["default"].createElement(components.Text, { className: 'controller__info' }, dayjsDate.format(monthFormat))),
            hideArrow ? null : (React__default["default"].createElement(components.View, { className: classnames('controller__arrow controller__arrow--right', {
...
var AtCalendar = /** @class */ (function (_super) {
    ...
    AtCalendar.prototype.render = function () {
        ...
        var _b = this.props, validDates = _b.validDates, marks = _b.marks, format = _b.format, minDate = _b.minDate, maxDate = _b.maxDate, isSwiper = _b.isSwiper, className = _b.className, hideArrow = _b.hideArrow, isVertical = _b.isVertical, monthFormat = _b.monthFormat, selectedDates = _b.selectedDates, formatter = _b.formatter;
        return (React__default["default"].createElement(components.View, { className: classnames('at-calendar', className) },
            React__default["default"].createElement(AtCalendarController, { minDate: minDate, maxDate: maxDate, hideArrow: hideArrow, monthFormat: monthFormat, generateDate: generateDate, onPreMonth: this.handleClickPreMonth, onNextMonth: this.handleClickNextMonth, onSelectDate: this.handleSelectDate }),
            React__default["default"].createElement(AtCalendarBody, { validDates: validDates, marks: marks, format: format, minDate: minDate, maxDate: maxDate, isSwiper: isSwiper, isVertical: isVertical, selectedDate: selectedDate, selectedDates: selectedDates, generateDate: generateDate, onDayClick: this.handleDayClick, onSwipeMonth: this.setMonth, onLongClick: this.handleDayLongClick, formatter: formatter })));
    };
