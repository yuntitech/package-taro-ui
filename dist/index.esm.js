...
var AtCalendarList = /** @class */ (function (_super) {
    ...
    AtCalendarList.prototype.render = function () {
        ...
        if (!list || list.length === 0)
            return null;
        return (React.createElement(View, { className: 'at-calendar__list flex' }, list.map(function (item) {
            var customRender = formatter ? formatter(item).customRender : null;
            return (React.createElement(View, { key: "list-item-".concat(item.value), onClick: _this.handleClick.bind(_this, item), onLongPress: _this.handleLongClick.bind(_this, item), className: classnames('flex__item', "flex__item--".concat(MAP[item.type]), {
                ...
                React.createElement(View, { className: 'flex__item-container' }, customRender ? customRender : (React.createElement(View, { className: 'container-text' }, item.text))),
            ...
            return (React.createElement(View, { className: classnames('main', 'at-calendar-slider__main', "at-calendar-slider__main--".concat(process.env.TARO_ENV)) },
                ...
                React.createElement(View, { className: 'main__body body' },
                    React.createElement(View, { className: 'body__slider body__slider--now' },
                        React.createElement(AtCalendarList, { formatter: formatter, list: listGroup[1].list, onClick: this.props.onDayClick, onLongClick: this.props.onLongClick })))));
        }
            ...
            return (React.createElement(View, { className: classnames('main', 'at-calendar-slider__main', "at-calendar-slider__main--".concat(process.env.TARO_ENV)), onTouchEnd: this.handleTouchEnd, onTouchMove: this.handleTouchMove, onTouchStart: this.handleTouchStart },
                ...
                React.createElement(View, { className: classnames('main__body  body', {
                    ...
                    React.createElement(View, { className: 'body__slider body__slider--pre' },
                        React.createElement(AtCalendarList, { list: listGroup[0].list, formatter: formatter })),
                    React.createElement(View, { className: 'body__slider body__slider--now' },
                        React.createElement(AtCalendarList, { list: listGroup[1].list, onClick: this.props.onDayClick, onLongClick: this.props.onLongClick, formatter: formatter })),
                    React.createElement(View, { className: 'body__slider body__slider--next' },
                        React.createElement(AtCalendarList, { list: listGroup[2].list, formatter: formatter })))));
        }
        return (React.createElement(View, { className: classnames('main', 'at-calendar-slider__main', "at-calendar-slider__main--".concat(process.env.TARO_ENV)) },
            React.createElement(AtCalendarHeader, null),
            React.createElement(Swiper, { circular: true, current: 1, skipHiddenItemLayout: true, className: classnames('main__body'), onChange: this.handleChange, vertical: this.props.isVertical, onAnimationFinish: this.handleAnimateFinish, onTouchEnd: this.handleSwipeTouchEnd, onTouchStart: this.handleSwipeTouchStart }, listGroup.map(function (item, key) { return (React.createElement(SwiperItem, { key: key, itemId: key.toString() },
                React.createElement(AtCalendarList, { formatter: formatter, list: item.list, onClick: _this.props.onDayClick, onLongClick: _this.props.onLongClick }))); }))));
    };
